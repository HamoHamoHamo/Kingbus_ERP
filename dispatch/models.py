...
class DispatchOrder(models.Model):
    ...
    deposit_status = models.CharField(verbose_name='입금현황', max_length=100, null=False, blank=True)
    ...
    order_type = models.CharField(verbose_name='유형', max_length=100, null=False, blank=True, default='기타')
    payment_method = models.CharField(verbose_name='결제방법', max_length=100, null=False, blank=True)
