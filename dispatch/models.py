...
class DispatchOrder(models.Model): #장고에서 제공하는 models.Model를 상속받아야한다.
    ...
    stopover = models.CharField(verbose_name='경유지', max_length=100, blank=True)
    brief = models.CharField(verbose_name="적요", max_length=50, null=False, default=str(departure_date))
    def __str__(self):
        return self.brief
'''
