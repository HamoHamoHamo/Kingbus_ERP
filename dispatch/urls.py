...
urlpatterns = [
    ...
    path('regularly/route/team', views.RouteTeamList.as_view(), name="route_team"),
    path('regularly/route/team/create', views.route_team_create, name="route_team_create"),
    path('regularly/route/team/edit', views.route_team_edit, name="route_team_edit"),
    path('regularly/route/team/delete', views.route_team_delete, name="route_team_delete"),
    path('regularly/route/team/save', views.route_team_save, name="route_team_save"),
