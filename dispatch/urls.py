...
urlpatterns = [
    ...
    path('regulraly/route/create', views.regularly_order_create, name="regularly_route_create"),
    path('regulraly/route/edit', views.regularly_order_edit, name="regularly_route_edit"),
    path('regulraly/route/delete', views.regularly_order_delete, name="regularly_route_delete"),
