...
class Outlay(models.Model):
    ...
    vendor = models.CharField(verbose_name='거래처', max_length=20, blank=True)
    salary_id = models.ForeignKey(Salary, on_delete=models.CASCADE, related_name="outlay_salary", db_column="salary_id" ,null=True)
    vehicle_id = models.ForeignKey(Vehicle, on_delete=models.SET_NULL, related_name="outlay_vehicle", null=True)
    brief = models.CharField(verbose_name='적요', max_length=50, null=False, default='')
    ...
    remark = models.CharField(verbose_name='비고', max_length=50, null=False, default='')
