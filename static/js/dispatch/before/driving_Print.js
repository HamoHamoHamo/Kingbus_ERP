const pageTitleYear = document.querySelector(".dataItemCellDate span:nth-child(1)")
const pageTitleMonth = document.querySelector(".dataItemCellDate span:nth-child(2)")
const pageTitleDate = document.querySelector(".dataItemCellDate span:nth-child(3)")
const pageTitleWeek = document.querySelector(".dataItemCellDate span:nth-child(4)")
...
window.onload = function () {
    ...
    pageTitleWeek.innerText = `${toDay}요일`
