...
function totalSalary(){
    ...
    for (i = 0; i < salaryItem.length; i++){
        price1 = price1 + parseInt(salaryItem[i].children[4].children[0].value.replace(/\,/g,""))
        price2 = price2 + parseInt(salaryItem[i].children[5].children[0].value.replace(/\,/g,""))
        price3 = price3 + parseInt(salaryItem[i].children[6].children[0].value.replace(/\,/g,""))
        price4 = price4 + parseInt(salaryItem[i].children[7].innerText.replace(/\,/g,""))
        price5 = price5 + parseInt(salaryItem[i].children[8].innerText.replace(/\,/g,""))
        price6 = price6 + parseInt(salaryItem[i].children[9].innerText.replace(/\,/g,""))
        price7 = price7 + parseInt(salaryItem[i].children[10].innerText.replace(/\,/g,""))
        price8 = price8 + parseInt(salaryItem[i].children[11].innerText.replace(/\,/g,""))
        price9 = price9 + parseInt(salaryItem[i].children[12].innerText.replace(/\,/g,""))
        price10 = price10 + parseInt(salaryItem[i].children[13].innerText.replace(/\,/g,""))
    };
