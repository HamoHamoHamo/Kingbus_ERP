...
function openPopup() {
    ...
    PopupData[1].innerText = regDatas[this.parentNode.parentNode.className].departure
    PopupData[2].innerText = regDatas[this.parentNode.parentNode.className].bus_cnt
    PopupData[3].innerText = regDatas[this.parentNode.parentNode.className].arrival
    PopupData[4].innerText = regDatas[this.parentNode.parentNode.className].bus_type
    PopupData[5].innerText = `${regDatas[this.parentNode.parentNode.className].departure_date} ~ ${regDatas[this.parentNode.parentNode.className].arrival_date}`
    PopupData[6].innerText = regDatas[this.parentNode.parentNode.className].contract_status
    PopupData[7].innerText = regDatas[this.parentNode.parentNode.className].cost_type
    PopupData[8].innerText = regDatas[this.parentNode.parentNode.className].references
    PopupData[9].innerText = regDatas[this.parentNode.parentNode.className].customer
    PopupData[10].innerText = regDatas[this.parentNode.parentNode.className].customer_phone
    PopupData[11].innerText = regDatas[this.parentNode.parentNode.className].price
    PopupData[12].innerText = regDatas[this.parentNode.parentNode.className].deposit_status
    PopupData[13].innerText = regDatas[this.parentNode.parentNode.className].deposit_date
    PopupData[14].innerText = regDatas[this.parentNode.parentNode.className].bill_date
    PopupData[15].innerText = regDatas[this.parentNode.parentNode.className].collection_type
    PopupData[16].innerText = regDatas[this.parentNode.parentNode.className].driver_allowance
    if (regDatas[this.parentNode.parentNode.className].payment_method == "y") {
        PopupData[17].innerText = "선지급"
    } else {
        PopupData[17].innerText = "x"
    }
    if (regDatas[this.parentNode.parentNode.className].VAT == "y") {
        PopupData[18].innerText = "포함"
    } else {
        PopupData[18].innerText = "x"
    }
    sendToHidden.value = this.parentNode.parentNode.className;
    PopupDataInputPrice.value = regDatas[this.parentNode.parentNode.className].collection_amount.replace(/\B(?=(\d{3})+(?!\d))/g, ',')
    PopupDataInputDate.value = regDatas[this.parentNode.parentNode.className].collection_date
}
