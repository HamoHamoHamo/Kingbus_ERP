...
FIXED_WORK_HOURS = {
    130: [('04:00', '10:00'), ('17:00', '20:00')],  # 전민철의 ID가 1일 경우
    106: [('05:00', '09:00'), ('15:00', '19:00')],  # 김영천의 ID가 2일 경우
    251: [('05:00', '14:00')],                      # 목진국의 ID가 3일 경우
    267: [('06:00', '09:00'), ('17:00', '24:00')],  # 박우덕의 ID가 4일 경우
    460: [('13:00', '22:00')],                      # 추광엽의 ID가 5일 경우
    53: [('05:00', '09:00'), ('15:00', '19:00')],  # 홍대수의 ID가 6일 경우
}
